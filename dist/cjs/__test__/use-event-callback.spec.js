...
describe('useEventCallback specs', function() {
  function createFixture(factory, initialValue) {
    return function Fixture() {
      var _a = tslib_1.__read(use_event_callback_1.useEventCallback(factory, initialValue), 2),
        callback = _a[0],
        value = _a[1]
  ...
  it('should handle the inputs changed', function() {
    ...
    var factory = function(event$, inputs$, _state$) {
      return event$.pipe(
        operators_1.combineLatest(inputs$),
        operators_1.map(function(_a) {
          var _b = tslib_1.__read(_a, 2),
            _ = _b[0],
            _c = tslib_1.__read(_b[1], 1),
            count = _c[0]
          return value + count
        }),
        operators_1.delay(timeToDelay),
    ...
    function Fixture(props) {
      var _a = tslib_1.__read(use_event_callback_1.useEventCallback(factory, initialValue, [props.count]), 2),
        clickCallback = _a[0],
        stateValue = _a[1]
      return react_1.default.createElement(
        react_1.default.Fragment,
